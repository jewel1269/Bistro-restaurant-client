...
console.log(items);
  ...
  return (
    ...
    <div className="px-6 py-4">
        ...
        <GiPriceTag />
            <h1 className="px-2 text-sm font-bold text-red-400">${item.price}</h1>
        </div>
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
           ...
           <button className="btn shadow-xl btn-sm border-0 border-b-4 shadow-slate-700 mt-4 hover:bg-green-600 btn-outline">Order Now</button>
           </div>
        </div>
    </div>
</div>
